...
# data: generated by 1_Null_Distribution.R script
...
save(Esig, Msig, file = "BRCA_CCLE_Esig_Msig.rda")
...
#
##################################################################
# data: https://github.com/KlinkeLab/DigitalCytometry_EMT_2020/blob/master/Files/BrCaCellLines-IntrinsicSubtypes.csv
BrCaTypes.file.name <- "BrCaCellLines-IntrinsicSubtypes.csv"
