...
# data: generated by 2_CCLE_BRCA_PCA.R
load(file = "BRCA_CCLE_Esig_Msig.rda")

#######################
# data: https://github.com/KlinkeLab/DigitalCytometry_EMT_2020/blob/master/Files/Fibroblasts.csv
FIBROgs.file.name <- "Fibroblasts.csv"
...
save(E_TGenes, M_TGenes, file = "BRCA_TCGA_Esig_Msig.rda")
